...
<xsl:template match="/pokedex">
    <xsl:apply-templates select="pokemon[types/type[text()='fire' or text()='water' or text()='flying' or text()='ground']]" />
</xsl:template>
 -->
...
<!-- In this template, select all the pokemon that are fire, water, flying or ground -->
<xsl:template match="/pokedex">
  <xsl:variable name="pokemonResults" select="pokemon[types/type[text()='fire' or text()='water' or text()='flying' or text()='ground']]" />
